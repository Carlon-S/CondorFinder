...
// Separado de navigation-menu.tsx: exportar una constante junto a los
// componentes de ese archivo rompía el contrato de Fast Refresh de Vite
// (forzaba un full reload del programa entero en cada cambio, en vez de
// un hot-patch).
