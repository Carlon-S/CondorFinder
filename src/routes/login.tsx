...
import { Eye, EyeOff, Loader2, LogIn } from "@/components/icons/Icons";
...
function LoginPage() {
  ...
  return (
    ...
    // var(--border), etc.). Sin trama de fondo: el fondo es liso en toda la app.
    <div className="login-dark flex min-h-screen items-center justify-center px-4">
